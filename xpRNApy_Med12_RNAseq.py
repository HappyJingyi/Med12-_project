...
def newXAnalysis():
    ...
    analysis.addReadCountDataFiles(getSampleList(), path=DATAPATH, suffix="_counts") # counts") # use the sample identifiers as addReadCountDataFiles will construct the actual filenames
...
DATAPATH = "/home/invictus/RNAseq_ANALYSIS/Analysis/" # "/home/linux/Asuns_Data/Asun_FastQ/" #
genotypes = ["WT", "Med12"] #"Ubn1", "Ubn2", "Ubn1/2", "Hira", "Ubn1_2"]
conditions = ["Ctrl", "Dox"]
cellLines = { "WT": ["WT1", "WT2"],
              "Med12": ["F5", "H11"] }
"""
